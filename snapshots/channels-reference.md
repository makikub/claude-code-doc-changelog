...
To use an existing channel instead of building one, see [Channels](</docs/en/channels>). Telegram, Discord, and fakechat are included in the research preview.
...
See also
  ...
  * [Channels](</docs/en/channels>) to install and use Telegram, Discord, or the fakechat demo, and to enable channels for a Team or Enterprise org
