...
[Cross-session messaging](</docs/en/cross-session-messaging>)| ✓ 5| ✓ (same machine) 5| ✓ (same machine) 5| ✓ (same machine) 5| ✓ (same machine) 5| ✓ (same machine) 5
...
---|---|---|---|---
[Cloud sessions](</docs/en/claude-code-on-the-web>)| ✓| ✓| ✓| ✓ 6
