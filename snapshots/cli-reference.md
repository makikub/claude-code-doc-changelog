...
`--dangerously-skip-permissions`| Skip permission prompts (use with caution). See [permission modes](</docs/en/permissions#permission-modes>) for what this does and does not skip| `claude --dangerously-skip-permissions`
...
`--permission-mode`| Begin in a specified [permission mode](</docs/en/permissions#permission-modes>)| `claude --permission-mode plan`
