...
Use the Amazon Bedrock job example to exchange the job’s OIDC token for temporary AWS credentials at runtime.
...
Use the Agent Platform job example to authenticate without storing keys.
