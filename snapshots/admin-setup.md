...
[Hook restrictions](</docs/en/settings#hook-configuration>)| Restrict which hooks run and restrict HTTP hook URLs; see [Hook configuration](</docs/en/settings#hook-configuration>) for the full effect list| `allowManagedHooksOnly`, `allowedHttpHookUrls`
