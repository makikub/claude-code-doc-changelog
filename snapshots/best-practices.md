...
---|---|---
**Provide verification criteria**|  _”implement a function that validates email addresses"_| _"write a validateEmail function. example test cases:[[email protected]](email-protected) is true, invalid is false, [[email protected]](email-protected) is false. run the tests after implementing”_
