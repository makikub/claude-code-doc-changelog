...
These errors come from the [install script](</docs/en/setup#install-claude-code>) before Claude Code has started. For `command not found`, PATH, permission, and TLS problems during setup, see [Troubleshoot installation and login](</docs/en/troubleshoot-install>).
...
**What to do:**
  ...
  * If the message names `.claude/settings.local.json` and you started Claude Code outside a git repository or in your home directory, update to v2.1.200 or later. Versions 2.1.196 through 2.1.199 treated your own `.claude/settings.local.json` as repository-supplied in those workspaces. See [Project allow rules and workspace trust](</docs/en/permissions#project-allow-rules-and-workspace-trust>).
