...
Administrators can configure OpenTelemetry settings for all users through the [managed settings file](</docs/en/settings#settings-files>). See the [settings precedence](</docs/en/settings#settings-precedence>) for more information about how settings are applied. Example managed settings configuration:
