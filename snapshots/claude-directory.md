...
Files older than [`cleanupPeriodDays`](</docs/en/settings#available-settings>) (default 30) are deleted on the next startup.
...
`plans/`| Plan files written during [plan mode](</docs/en/permission-modes#plan-mode>)
